...
export default function WhatsAppFloater() {
    return (
        <div className="fixed bottom-8 right-8 z-50 flex items-center justify-center group">
            ...
            {/* Static Button */}
            <a
                href="https://wa.me/919031074805"
                target="_blank"
                rel="noopener noreferrer"
                className="relative z-10 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform active:scale-95 flex items-center justify-center"
            >
