...
export default function CTA() {
    return (
        <SectionWrapper className="bg-white relative overflow-hidden flex items-center justify-center text-center py-32">
            {/* Background Effect */}
            ...
            <div className="container mx-auto px-6 relative z-10">
                <h2 className="text-5xl md:text-7xl font-serif font-bold text-bmd-navy mb-8">
                    Ready to Build <br /> <span className="text-bmd-gold">The Future?</span>
                </h2>
                <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto mb-12 font-light">
                ...
                >
                    <MagneticButton className="bg-bmd-navy text-white hover:bg-bmd-gold hover:text-bmd-navy border-transparent px-10 py-4 text-base">
                        Start Your Project
                    </MagneticButton>
                </a>
            </div>
