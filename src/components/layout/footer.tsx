        ...
        <footer className="bg-bmd-navy text-white pt-12 md:pt-20 pb-12 md:pb-10 border-t border-white/10 relative overflow-hidden">
            <div className="container mx-auto px-6 md:px-12 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 mb-16">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start space-x-4 text-gray-400 text-sm group">
                                    <div className="mt-1 w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:border-bmd-gold/30 transition-all duration-300">
                                        <MapPin size={18} className="text-bmd-gold" />
                                    </div>
                                ...
                                <div className="flex items-center space-x-4 text-gray-400 text-sm group">
                                    <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:border-bmd-gold/30 transition-all duration-300">
                                        <Phone size={18} className="text-bmd-gold" />
                                    </div>
                                    <span className="group-hover:text-white transition-colors">+91 90310 74805</span>
                                </div>
                                <div className="flex items-center space-x-4 text-gray-400 text-sm group">
                                    <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0 group-hover:border-bmd-gold/30 transition-all duration-300">
                                        <Mail size={18} className="text-bmd-gold" />
                                    </div>
                            ...
                            <div className="flex space-x-3 pt-4">
                                {[Facebook, Twitter, Instagram, Linkedin].map((Icon, i) => (
                                    <a
                                        ...
                                        className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:border-bmd-gold/30 transition-all duration-300"
                                    >
                                        <Icon size={18} />
                                    </a>
                                ))}
                    ...
                    <div className="bg-bmd-navy-light p-8 rounded-2xl border border-white/5 shadow-2xl">
                        <h3 className="text-2xl font-serif text-white mb-2">Schedule a Call Back</h3>
                        ...
                        <form onSubmit={handleWhatsAppSubmit} className="space-y-4">
                            <input
                                ...
                                className="w-full bg-bmd-navy border border-white/10 p-3.5 rounded-xl text-white focus:border-bmd-gold/50 focus:ring-2 focus:ring-bmd-gold/20 outline-none transition-all text-sm"
                                value={formData.name}
                ...
                <div ref={mapRef} className="w-full h-48 md:h-64 transition-all duration-500 rounded-xl overflow-hidden border border-white/10 mb-12 relative group bg-bmd-navy-light">
                    {showMap ? (
                        <iframe
                        ...
                        <div className="flex items-center justify-center h-full text-gray-500 text-sm">
                            <MapPin size={20} className="mr-2 text-bmd-gold" /> Loading map...
                        </div>
                    )}
                    ...
                    <div className="absolute inset-0 bg-bmd-navy/60 backdrop-blur-[2px] opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center">
                        ...
                        >
                            <MagneticButton className="px-6 py-3 bg-white text-bmd-navy hover:bg-bmd-gold flex items-center gap-2 font-bold shadow-xl transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 rounded-full border border-white/20">
